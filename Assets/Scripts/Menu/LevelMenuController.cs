...
public class LevelMenuController : MonoBehaviour
{
    ...
    private event Action<bool, Level> m_OnToggleLevelMenu;
    ...
    public void SubscribeOnToggleLevelMenu(Action<bool, Level> action)
    {
    ...
    {
        Level level = GetLevelAt(currentLevelId);
